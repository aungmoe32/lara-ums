    ...
    <nav class="mt-5 px-2">
        ...
        <div x-data="{ open: true }" class="mb-2">
            <button @click="open = !open"
                ...
                <span class="flex-1 text-left">Custom Domains</span>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 transform" :class="{ 'rotate-180': open }"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                </svg>
            ...
            <div x-show="open" class="pl-4">
                <a href="{{ route('domains.index') }}"
                    class="block py-2 px-4 text-sm text-gray-300 hover:bg-gray-800 rounded-md">My Domains</a>
                <a href="{{ route('domains.create') }}"
                    class="block py-2 px-4 text-sm text-gray-300 hover:bg-gray-800 rounded-md">Add Domain</a>
            </div>
        </div>
        @endif
    </nav>
