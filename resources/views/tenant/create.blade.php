<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-2">
            <a href="{{ route('tenants.index') }}" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('tenants.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">A unique identifier for this tenant (e.g., company-name)</p>
